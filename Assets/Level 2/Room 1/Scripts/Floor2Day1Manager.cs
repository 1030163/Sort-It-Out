...
public class Floor2Day1Manager : MonoBehaviour
{
    ...
    [SerializeField] PackageLocation packageLocation1;
    [SerializeField] PackageLocation packageLocation2;
    ...
    void Update()
    {
        ...
        if (packageLocation2.isCorrectPackage && !wesleyPaintsDelivered)
        {
